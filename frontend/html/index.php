...
<body>
    <!-- Сайдбар -->
    <div id="sidebar">
        <div id="welcome">Добро пожаловать в отдел ЦУС</div>
        <div class="welcome-dropdown">
            <nav>
                <a href="about.php" class="nav-button">Для реальных админов</a>
                <a href="api.php" class="nav-button">Статьи</a>
    ...
    <div class="profile-container">
        ...
        <div class="profile-dropdown">
            ...
            <button id="adminButton" style="display: none;">Админ</button>
    ...
    <!-- Содержимое мессенджера без inline-стилей -->
