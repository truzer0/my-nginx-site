                          ...
                          <li key={feature.name} className="flex gap-x-3">
                            ...
                            <span>
                              ...
                              {typeof feature.tiers[tier.name] === 'string' ? (
                                <span className="text-sm/6 text-gray-500">({feature.tiers[tier.name] as string})</span>
                              ) : null}
                            </span>
                          </li>
                        ) : null,
                      ...
                      <tr key={feature.name}>
                        ...
                        {tiers.map((tier) => (
                          <td key={tier.id} className="px-6 py-4 xl:px-8">
                            {typeof feature.tiers[tier.name] === 'string' ? (
                              <div className="text-center text-sm/6 text-gray-500">{feature.tiers[tier.name] as string}</div>
                            ) : (
                              <>
